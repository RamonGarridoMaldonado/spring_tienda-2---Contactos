...
CREATE TABLE `Detalle_Pedido` (
  ...
  CONSTRAINT `Detalle_Pedido_ibfk_1` FOREIGN KEY (`codigo_pedido`) REFERENCES `Pedidos` (`codigo`),
  CONSTRAINT `Detalle_Pedido_ibfk_2` FOREIGN KEY (`codigo_producto`) REFERENCES `Productos` (`codigo`)
...
BEGIN
    ...
    loop1: loop
		...
		insert into Productos (nombre, descripcion, precio, image)
		values(_nombre, _descripcion, _precio, _image);
...
-- Dump completed on 2022-12-01 10:46:19
